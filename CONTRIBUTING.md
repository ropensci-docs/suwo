...
> of Conduct](https://docs.ropensci.org/suwo/CODE_OF_CONDUCT.md). By
> participating, you are expected to uphold this code. Please report
> unacceptable behavior to <https://github.com/ropensci/suwo/issues/>.

## I Have a Question

If you want to ask a question, we assume that you have read the
available
[Documentation](https://docs.ropensci.org/suwo/articles/suwo.html).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/ropensci/suwo/issues/) that might help you.
...
- Open an
  [https://github.com/ropensci/suwo/issues/](https://github.com/ropensci/suwo/issues/new).
...
- Determine if your bug is really a bug and not an error on your side
  ...
  [documentation](https://docs.ropensci.org/suwo/articles/suwo.html). If
...
- Open an [Issue](https://github.com/ropensci/suwo/issues/new). (Since
...
- Perform a [search](https://github.com/ropensci/suwo//issues) to see if
...
issues](https://github.com/ropensci/suwo/issues/).
